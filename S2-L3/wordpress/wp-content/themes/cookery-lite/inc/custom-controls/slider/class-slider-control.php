<?php
/**
 * Cookery Lite Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Cookery_Lite_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Cookery_Lite_Slider_Control extends WP_Customize_Control {

		public $type = 'cookery-lite-slider';
        ...
        public function enqueue() {            
            wp_enqueue_style( 'cookery-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'cookery-lite-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }
