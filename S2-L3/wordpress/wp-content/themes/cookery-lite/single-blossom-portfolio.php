...
$related_image_size = ( $portfolio_crop ) ? 'full' : 'cookery-lite-single';
...
while ( have_posts() ) : the_post();
    ...
    $related_title = get_theme_mod( 'related_portfolio_title', __( 'Related Projects', 'cookery-lite' ) );
